package simple.job.common.idgeneate;
 ...
 * @author 方浩
 * @version 1.0.0
 * @date 2023/06/04 14:26:48
 */
public class SnowFlakeIdGenerate implements IIdGenerate {
    private static SnowFlakeIdGenerate snowFlakeIdGenerate;

    static {
        snowFlakeIdGenerate = new SnowFlakeIdGenerate();
    }
     ...
     * @param workerId
     */
    public SnowFlakeIdGenerate(long dataCenterId, long workerId) {
        // 检查dataCenterId的合法值
    ...
    public synchronized String nextId() {
        ...
        return
                // 时间戳部分
                String.valueOf(((currentTimeMillis - INIT_EPOCH) << TIMESTAMP_SHIFT)
                        // 数据中心部分
